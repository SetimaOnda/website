...
<head>
    ...
    <meta charset="utf-8">
    <link rel="icon" href="https://setimaondaboattrips.com/img/logo.png" type="image/x-icon">
    <!-- Stylesheets-->
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-M3E6CEQJ83"></script>
    <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'G-M3E6CEQJ83');
    </script>
    ...
    })(window,document,'script','dataLayer','GTM-KT32JV7');</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KT32JV7"
        ...
        <section class="section section-sm section-first bg-default text-md-left" style="margin-top:2rem;">
            <div class="container">
                ...
                <div class="row row-50 justify-content-center align-items-xl-center ">
                    <div class="col-md-10 col-lg-5 col-xl-6 image"><img style="height:382px;width:556px"
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="tabs-7-1">
                                        ...
                                        <div class="group-md group-middle"><a
                                                ...
                                                data-toggle="modal"
                                                data-target="#book">{{__('messages.book_button')}}</a>
                                        </div>
                                    </div>
            ...
            <div class="owl-carousel owl-classic owl-timeline" data-items="1" data-md-items="2" data-lg-items="3"
                ...
                <div class="owl-item">
                    ...
                    <article class="thumbnail thumbnail-mary">
                        <div class="thumbnail-mary-figure"><img src="img/img/galeria/foto5.png" alt="" width="420"
                                height="308" />
                        </div>
                        <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60"
                                href="img/img/galeria/foto5.png" data-lightgallery="item"><img
                                    src="img/img/galeria/foto5.png" alt="" width="420" height="308" /></a>
                        </div>
                    </article>
                ...
                <div class="owl-item">
                    <!-- Thumbnail Classic-->
                    <article class="thumbnail thumbnail-mary">
                        <div class="thumbnail-mary-figure"><img src="img/img/galeria/foto1.png" alt="" width="420"
                                height="308" />
                        </div>
                        <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60"
                                href="img/img/galeria/foto1.png" data-lightgallery="item"><img
                                    src="img/img/galeria/foto1.png" alt="" width="420" height="308" /></a>
                        </div>
                    </article>
                    <div class="thumbnail-mary-description">
                ...
                <div class="owl-item">
                    <!-- Thumbnail Classic-->
                    <article class="thumbnail thumbnail-mary">
                        <div class="thumbnail-mary-figure"><img src="img/img/galeria/foto6.png" alt="" width="420"
                                height="308" />
                        </div>
                        <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60"
                                href="img/img/galeria/foto6.png" data-lightgallery="item"><img
                                    src="img/img/galeria/foto6.png" alt="" width="420" height="308" /></a>
                        </div>
                    </article>
                    <div class="thumbnail-mary-description">
                ...
                <div class="owl-item">
                    <!-- Thumbnail Classic-->
                    <article class="thumbnail thumbnail-mary">
                        <div class="thumbnail-mary-figure"><img src="img/img/galeria/foto7.png" alt="" width="420"
                                height="308" />
                        </div>
                        <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60"
                                href="img/img/galeria/foto7.png" data-lightgallery="item"><img
                                    src="img/img/galeria/foto7.png" alt="" width="420" height="308" /></a>
                        </div>
                    </article>
                    <div class="thumbnail-mary-description">
                ...
                <div class="parallax-content section-xl context-dark bg-overlay-26">
                    <div class="container">
                        <div class="row row-50 justify-content-center border-classic">
                            ...
                            <div class="col-sm-6 col-md-5 col-lg-3">
                                <div class="counter-classic">
                                    <div class="counter-classic-number"><span class="counter">100</span><span
                                            class="symbol"></span>
                                    </div>
        ...
        <div id="whatswidget-widget-wrapper" class="whatswidget-widget-wrapper" style="all:revert;">
            <div id="whatswidget-conversation" class="whatswidget-conversation"
                ...
                <div id="whatswidget-conversation-message" class="whatswidget-conversation-message "
                    style="all:revert;"> <span style="all:revert;">Do you need help?</span>
                </div>
            ...
            <div class="whatswidget-button-wrapper" style="all:revert;">
                <div class="whatswidget-button" id="whatswidget-button" style="all:revert;">
                    <div style="margin:0 auto;width:38.5px;all:revert;"> <img alt="what" class="whatswidget-icon"
                            style="all:revert;"
