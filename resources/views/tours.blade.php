                                    ...
                                    <!-- <div class="row">
                                        <div class="col-md-4">
                                            <p style="font-size:1.1rem; color:#162e44"><b>PREÇO ADULTO:</b>
                                                <br>
                                                <img src="img/wallet.png" alt="" style="height:2rem;">
                                                <b style="margin-left:0.8rem;font-size:1rem; color:#162e44">22,5€</b>
                                            </p>
                                        </div>
                                        <div class="col-md-4">
                                            <p style="font-size:1.1rem;color:#162e44"><b>PREÇO CRIANÇA:</b>
                                                <br>
                                                <img src="img/wallet.png" alt="" style="height:2rem;">
                                                <b style="margin-left:0.8rem;font-size:1rem; color:#162e44">12,5€</b>
                                            </p>
                                        </div>
                                        <div class="col-md-4">
                                            <p style="font-size:1.1rem;color:#162e44"><b>DURAÇÃO:</b><br>
